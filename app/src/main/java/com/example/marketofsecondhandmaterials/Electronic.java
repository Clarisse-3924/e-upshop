...
public class Electronic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("electronic");
        mDatabase = FirebaseDatabase.getInstance().getReference("electronic");
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Electronic.this,Electronicview.class));
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(muploadTask != null && muploadTask.isInProgress()){
                    Toast.makeText(Electronic.this,"upload in progress",Toast.LENGTH_SHORT).show();
                }else {
                    uploadFile();
                }
            }
            ...
            muploadTask =fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(Electronic.this,"Upload sucessful",Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Electronic.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    })
