...
public class furnitureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_furniture2);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Furniture");
        mDatabase = FirebaseDatabase.getInstance().getReference("Furniture");
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(furnitureActivity.this,Furnitureview.class));
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(muploadTask != null && muploadTask.isInProgress()){
                    Toast.makeText(furnitureActivity.this,"upload in progress",Toast.LENGTH_SHORT).show();
                }else {
                    uploadFile();
                }
            }
            ...
            muploadTask =fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(furnitureActivity.this,"Upload sucessful",Toast.LENGTH_LONG).show();
